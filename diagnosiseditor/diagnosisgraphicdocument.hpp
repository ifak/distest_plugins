...
//namespace view{ namespace ts{ class DiagnosisScene;}}

namespace diagnosiseditor {

class DIAGNOSISEDITOR_EXPORT DiagnosisGraphicDocument
    : public Core::IDocument
{
  Q_OBJECT

public:
  DiagnosisGraphicDocument(QObject *parent = 0);
  virtual ~DiagnosisGraphicDocument();

public:
//  view::diagnosis::DiagnosisScene*  diagnosisScene();
...
private:
  Q_DISABLE_COPY(DiagnosisGraphicDocument)
  class Private;
  Private* _d;
};
