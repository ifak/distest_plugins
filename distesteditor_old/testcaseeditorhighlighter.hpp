...
*/
#ifndef DISTESTEDITOR_TESTCASEEDITORHIGHLIGHTER_HPP
#define DISTESTEDITOR_TESTCASEEDITORHIGHLIGHTER_HPP

#include "distestdslhighlighter.hpp"

namespace distesteditor{

class DISTESTEDITOR_EXPORT TestCaseEditorHighlighter
    : public DisTestDslHighlighter
{
  Q_OBJECT

public:
  TestCaseEditorHighlighter(QTextDocument *parent = 0);
  virtual ~TestCaseEditorHighlighter();
};

} // namespace distesteditor

#endif // DISTESTEDITOR_TESTCASEEDITORHIGHLIGHTER_HPP
