...
*/
#ifndef DISTESTEDITOR_TESTREPORTGRAPHICEDITOR_HPP
#define DISTESTEDITOR_TESTREPORTGRAPHICEDITOR_HPP

#include "distesteditor_global.hpp"

#include "distestproject/distestruntime/distestruntime.hpp"
...
class DISTESTEDITOR_EXPORT TestReportGraphicEditor
    : public Core::IEditor
{
  Q_OBJECT
...
#endif // DISTESTEDITOR_TESTREPORTGRAPHICEDITOR_HPP
