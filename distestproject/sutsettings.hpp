...
*/
#ifndef DISTESTPROJECT_DISTESTSUTSETTINGS_HPP
#define DISTESTPROJECT_DISTESTSUTSETTINGS_HPP
...
class DISTESTPROJECTSHARED_EXPORT DisTestSutSettings
{
public:
    DisTestSutSettings();
    DisTestSutSettings(const DisTestSutSettings &source);
...
inline bool operator==(const DisTestSutSettings &p1, const DisTestSutSettings &p2)
{
