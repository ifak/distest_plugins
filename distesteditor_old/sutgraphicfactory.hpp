...
*/
#ifndef DISTESTEDITOR_SUTGRAPHICFACTORY_HPP
#define DISTESTEDITOR_SUTGRAPHICFACTORY_HPP
...
class DISTESTEDITOR_EXPORT SutGraphicFactory
    : public Core::IEditorFactory
{
  Q_OBJECT

public:
  SutGraphicFactory(QObject *parent = 0);
  virtual ~SutGraphicFactory();
...
#endif // DISTESTEDITOR_SUTGRAPHICFACTORY_HPP
