...
*/
#ifndef DISTESTEDITOR_TESTCASEEDITORFACTORY_HPP
#define DISTESTEDITOR_TESTCASEEDITORFACTORY_HPP
...
class TestCaseEditorFactory : public Core::IEditorFactory
{
  Q_OBJECT

public:
  explicit TestCaseEditorFactory(DisTestEditorPlugin *owner);
...
#endif //DISTESTEDITOR_TESTCASEEDITORFACTORY_HPP
