...
*/
#ifndef DISTESTEDITOR_SUTEDITORHIGHLIGHTER_HPP
#define DISTESTEDITOR_SUTEDITORHIGHLIGHTER_HPP

#include "distestdslhighlighter.hpp"

namespace distesteditor{

class DISTESTEDITOR_EXPORT SutEditorHighlighter
    : public DisTestDslHighlighter
{
  Q_OBJECT

public:
  SutEditorHighlighter(QTextDocument *parent = 0);
  virtual ~SutEditorHighlighter();
};

} // namespace distesteditor

#endif // DISTESTEDITOR_SUTEDITORHIGHLIGHTER_HPP
