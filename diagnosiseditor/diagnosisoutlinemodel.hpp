...
public:
  DiagnosisOutlineModel(QObject* parent = 0);
  virtual ~DiagnosisOutlineModel();

public:
  model::diagnosis::DiagnosisItem*    diagnosisModel();
  QList<model::diagnosis::DiagnosisItem*> importItems();
public:
  virtual void reset();

private:
  Q_DISABLE_COPY(DiagnosisOutlineModel)
  class Private;
  Private* _d;
};
