...
class SutEditorOutlineTreeView
    : public Utils::NavigationTreeView
{
  Q_OBJECT

public:
  SutEditorOutlineTreeView(QWidget *parent);

  void contextMenuEvent(QContextMenuEvent *event);
};

class SutEditorOutlineWidget
    : public TextEditor::IOutlineWidget
{
  Q_OBJECT
public:
  SutEditorOutlineWidget(SutEditor* sutEditor);
...
private:
  Q_DISABLE_COPY(SutEditorOutlineWidget)
  class Private;
  Private* _d;
};

class SutEditorOutlineWidgetFactory
